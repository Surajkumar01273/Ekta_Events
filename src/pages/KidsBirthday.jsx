...
const KidsBirthday = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Kids Birthday Balloon Decoration near me | +91 9220586324</title>
        <meta
          name='description'
          content='Make your child’s birthday magical with Ekta Decoration colorful and creative balloon decorations in Gurugram. We specialize in themed balloon setups like cartoons, superheroes, princesses, jungle, and more to match your child’s favorite style. From balloon arches and character cutouts to ceiling décor and photo booths, we transform your space into a fun-filled party zone. Whether it’s at home or a party hall, our team ensures timely setup and high-quality decor that kids and guests will love. Celebrate your little one’s big day with joy, color, and creativity—only with Ekta Decoration’ expert balloon decoration services.'
        />
        <meta
          name='keywords'
          content='Kids Birthday Decoration Gurgaon, Children Birthday Party Decor, Cartoon Theme Birthday Decoration, Superhero Theme Party Gurgaon, Princess Theme Birthday Setup, Birthday Balloon Decoration for Kids, Creative Birthday Planners Gurgaon, Fun Birthday Decoration, Kids Party Decorators, Birthday Decoration at Home Gurgaon'
        />

        <meta
          property='og:title'
          content='Kids Birthday Decoration in Gurgaon | Ekta Decoration – Fun & Themed Party Decor Experts'
        />

        <meta
          property='og:description'
          content='Make your child’s birthday unforgettable with Ekta Decoration! We provide colorful kids birthday decorations, cartoon & superhero themes, balloon setups, and creative party décor services in Gurgaon.'
        />
        ...
        <meta
          property='og:url'
          content='https://www.ektadecoration.com/kids-birthday'
        />
        <meta property='og:type' content='website' />

        <link
          rel='canonical'
          href='https://www.ektadecoration.com/kids-birthday'
        />
      ...
      >
        <div className='relative z-10 text-center text-white'>
          <h1 className='text-4xl md:text-5xl font-bold mb-6'>Kids Birthday</h1>
