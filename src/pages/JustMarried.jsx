...
const JustMarried = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Just Married Balloon Decoration near me | +91 9220586324</title>
        <meta
          name='description'
          content='Celebrate your special day with Ekta Decoration romantic "Just Married" balloon decorations in Gurugram. We design elegant and customized balloon setups that highlight the joy of your wedding. From beautiful arches and heart-shaped arrangements to stunning photo backdrops and couple name displays, our team ensures every detail adds charm to your celebration. Perfect for receptions, homecoming, and wedding photo shoots, our decorations are crafted with premium-quality balloons in romantic colors like red, white, gold, and rose gold. '
        />
        <meta
          name='keywords'
          content='Just Married Decoration Gurgaon, Wedding Decoration Services, Romantic Balloon Decoration, Newlywed Room Decoration, Flower Decoration for Just Married, Couple Decoration Gurgaon, Wedding Night Room Setup, Romantic Decorators in Gurgaon, Wedding Event Decoration, Honeymoon Room Decoration'
        />

        <meta
          property='og:title'
          content='Just Married Decoration in Gurgaon | Ekta Decoration – Romantic Wedding & Room Decor Experts'
        />

        <meta
          property='og:description'
          content="Celebrate your special moments with Ekta Decoration! We create beautiful 'Just Married' decorations with romantic balloons, flowers, and elegant wedding setups in Gurgaon – perfect for couples and newlyweds."
        />
        ...
        <meta
          property='og:url'
          content='https://www.ektadecoration.com/just-married'
        />
        <meta property='og:type' content='website' />

        <link rel='canonical' href='https://www.ektadecoration.com/just-married' />
      ...
      >
        <div className='relative z-10 text-center text-white'>
          <h1 className='text-4xl md:text-5xl font-bold mb-6'>Just Married</h1>
