...
const BirthdayDecoration = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Birthday Ballon Decoration near me | +91 9220586324</title>
        <meta
          name='description'
          content='Make your birthday celebrations unforgettable with Ekta Decoration’ creative balloon decorations in Gurugram. From kids themes to elegant adult setups we deliver stunning decor tailored to your party. Trust us for vibrant balloons, backdrops, and budget-friendly packages.'
        />
        <meta
          name='keywords'
          content='Birthday Decoration Gurgaon, Birthday Party Balloon Decoration, Kids Birthday Themes, Birthday Room Decoration, Birthday Party Decorators Gurgaon, Creative Birthday Decoration, Balloon & Flower Decoration for Birthday, Home Birthday Decoration Gurgaon, Birthday Party Planners, Surprise Birthday Decoration'
        />

        <meta
          property='og:title'
          content='Birthday Decoration in Gurgaon | Ekta Decoration – Creative Balloon & Event Decor Experts'
        />

        <meta
          property='og:description'
          content='Celebrate birthdays with Ekta Decoration! We offer creative balloon setups, themed birthday decorations, kids’ party décor, elegant flower arrangements, and surprise birthday decorations at home or party halls in Gurgaon.'
        />
        ...
        <meta
          property='og:url'
          content='https://www.ektadecoration.com/birthday-decoration'
        />
        <meta property='og:type' content='website' />

        <link
          rel='canonical'
          href='https://www.ektadecoration.com/birthday-decoration'
        />
      ...
      >
        <div className='relative z-10 text-center text-white'>
          ...
          <p className='text-sm md:text-base'>
            ...
            <span className='mx-2 font-bold'>Birthday Decoration</span>
          </p>
        </div>
      </div>
